...
public class TileDesert extends Tile {
  private static final long serialVersionUID= 2685586079977282153L;

  /**
   * Creates a new TileDesert tile with the specified position x, y in the
