 ...
 *
 */
public class CrocWarrior extends Monster {

  /**
   * 
   * 
   */
  public CrocWarrior(int level) {
    // (NAME, GENDER, anim_dir, bHP, bMP, bSPD, bSTR, bINT, bXP, hpMult,
    // mpMult, baseWeap, e, xp, hpRange, mpRange, speedRange, strRange,
    // intRange)
    super(NAME + crocNumber, GENDER, ANIM_DIR, 20, 0, 7, 7, 0, XP_PER_KILL, 2,
  ...
  /* =========================== private parts ============================= */
  private static final String NAME= "CrocWarrior";
  private static final Gender GENDER= Gender.MALE;
  private static final String ANIM_DIR= NAME + File.separatorChar;
  private static int XP_PER_KILL= 400;
  private static final QuestEvent DIE_EVENT= new QuestEvent(NAME, QuestAction.KILL, null, null);
  private static final long serialVersionUID= -308325604588559721L;
  
  private static int crocNumber = 0;
  
  private static final int HP_RANGE =3;
  private static final int MP_RANGE=1;
  private static final int SPEED_RANGE=2;
