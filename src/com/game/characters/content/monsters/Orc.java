...
public class Orc extends Monster {
  ...
  public Orc(int level) {
    ...
    // intRange)
    super(NAME + orcNumber, GENDER, ANIM_DIR, 25, 0, 10, 15, 0, XP_PER_KILL, 2,
        2, null, DIE_EVENT, HP_RANGE, MP_RANGE, SPEED_RANGE, STR_RANGE,
        INT_RANGE);
    Weapon w= new GuruSourceSword();
    try {
  ...
  /* =========================== private parts ============================= */
  private static final String NAME= "Orc"; // TODO
  private static final Gender GENDER= Gender.MALE;
  private static final String ANIM_DIR= NAME + File.separatorChar;
  private static final int XP_PER_KILL= 500; // TODO
  private static final QuestEvent DIE_EVENT= new QuestEvent(NAME, QuestAction.KILL, null, null);
  private static final long serialVersionUID= -8525383534746421855L;

  private static int orcNumber= 0; // TODO

  private static final int HP_RANGE= 3; // TODO
  private static final int MP_RANGE= 1; // TODO
  private static final int SPEED_RANGE= 2; // TODO
  private static final int STR_RANGE= 5; // TODO
  private static final int INT_RANGE= 1; // TODO
}
