 ...
 * @author Ian
 */
public class CommandPrepareAction extends ComparableCommand {
	 ...
	 * @param new_state
	 */
	public CommandPrepareAction(String char_name, ActionType new_state, Directions new_direction, double vel_x, double vel_y) {
	...
	public String toString() {
		...
		builder.append("CommandPrepareAction [");
		if (new_state != null) {
