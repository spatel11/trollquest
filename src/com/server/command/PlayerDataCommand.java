...
public class PlayerDataCommand extends ComparableCommand {
	...
	/**
	 * Creates a new PlayerDataCommand for the specified user. This command will
	 * add the input player to the game State.
	 * 
	 * @param userName
	 *            the name of the user who is creating player.
	 * @param p
